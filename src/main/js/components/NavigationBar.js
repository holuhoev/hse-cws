...
const NavigationBar = ({activeItem, handleItemClick}) => (
    <Menu secondary pointing color='blue'>
        ...
        <Menu.Item name='student' primary active={activeItem === 'student'} onClick={handleItemClick}/>
        <Menu.Item name='lecturer' active={activeItem === 'lecturer'} onClick={handleItemClick}/>
